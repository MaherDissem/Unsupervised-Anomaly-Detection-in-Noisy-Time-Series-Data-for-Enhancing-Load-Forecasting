...
exp_parameters = [
    {"forecast_window_size": 8, "data_folder": "AEMO/NSW"},
    {"forecast_window_size": 8, "data_folder": "AEMO/QLD"},
    {"forecast_window_size": 8, "data_folder": "AEMO/SA"},
    {"forecast_window_size": 8, "data_folder": "AEMO/TAS"},
    {"forecast_window_size": 8, "data_folder": "AEMO/VIC"},
    {"forecast_window_size": 8, "data_folder": "Park/Commercial/30_minutes",},
    {"forecast_window_size": 8, "data_folder": "Park/Office/30_minutes",},
    {"forecast_window_size": 8, "data_folder": "Park/Residential/30_minutes",},
    {"forecast_window_size": 8, "data_folder": "Park/Public/30_minutes",},
    {"forecast_window_size": 8, "data_folder": "INPG"},
    ...
    {"forecast_window_size": 14, "forecast_sequence_split": 1/2, "data_folder": "AEMO/SA",},
    ...
    {"forecast_window_size": 14, "forecast_sequence_split": 1/2, "data_folder": "INPG",},
]
...
def get_default_parameters(params):
    ...
    params.setdefault("data_contam_rate", 0.1)
