...
dataset = TS_Dataset(args.dataset_root,
                     mask_data=True,
                     len_mask=8) # train version
train_dataset, test_dataset = torch.utils.data.random_split(dataset, [int(args.split_ratio * len(dataset)), len(dataset) - int(args.split_ratio * len(dataset))])
