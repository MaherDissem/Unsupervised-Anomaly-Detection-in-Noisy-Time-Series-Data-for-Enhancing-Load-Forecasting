...
class NearestNeighbourScorer(object):
    ...
    def predict(
        ...
        return anomaly_scores, query_distances, query_nns # how to infer single img or different batch size if batchsize x h x w x c is saved during batch training 
