...
class LSTM_AE(nn.Module):
    ...
    def vectorize(self, data):
        ...
        # forget the above thing, dont worry about training accuracy 
        # or  about learning from contaminated data.
        # anyway best case scenario will be a smoothed version of the signal so lets calc that directly
        # -> we will generate features using math functions (no training)
